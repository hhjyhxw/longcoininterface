...
public class MyPropertitys {
    ...
    public static class LongCoin{
        ...
        private List<String> sids;//商户号集合，用于下载对应的账单
        private String data_file_dir;//#账单文件路径
        private String data_bak_dir;//#下载完成后 的备份路径
        private String longcoin_data_bill;//#下载账单到本地路径
    }
}
